            ...
            <ul class="nav ace-nav">
                <li class="light-blue">
                    <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                        <span class="time"><em id="time"></em></span><span class="user-info"><small>欢迎光临,</small>{{ json_decode(session('info'))->username }} </span>
                    ...
                    <ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
                        ...
                        <li class="divider"></li>
                        <li><a href="javascript:ovid(0)" id="Exit_system" class='logout'><i class="icon-off"></i>退出</a></li>
                    </ul>
                </li>
                <li class="purple">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <ul class="nav nav-list" id="nav_list">
                ...
                <li><a href="#" class="dropdown-toggle"><i class="icon-desktop"></i><span
                    ...
                    <ul class="submenu">
                        <li class="home"><a href="/admin/products/list" name="Products_List.html" title="商品列表"
               ...
               <!--  <li>
                ...
                <li>
                    ...
                    <ul class="submenu">
                        <li class="home"><a href="/admin/orders/list" name="Orderform.html" title="订单列表"
                ...
                <li>
                    <a href="#" class="dropdown-toggle"><i class="icon-user"></i><span class="menu-text"> 会员管理 </span><b
                                class="arrow icon-angle-down"></b></a>
                    <ul class="submenu">
                        <li class="home"><a href="/admin/user/user" name="user_list.html" title="会员列表"
                ...
                <li><a href="#" class="dropdown-toggle"><i class="icon-group"></i><span class="menu-text"> 管理员管理 </span><b
                    ...
                    <ul class="submenu">
                        ...
                        <li class="home"><a href="/admin/role/view" name="admin_Competence.html" title="权限管理"
                                            class="iframeurl"><i class="icon-double-angle-right"></i>权限管理</a></li>
                        <li class="home"><a href="/admin/user/index" name="administrator.html" title="管理员列表"
